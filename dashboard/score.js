...
function calculateQualityBonus(article) {
    ...
    if (article.isAGrade) bonus += config.QUALITY_BONUS.isAGrade || 2;
 ...
 * @returns {object} { articleScore, penaltyScore, bonusScore, deductionScore, finalScore, penalties }
 */
